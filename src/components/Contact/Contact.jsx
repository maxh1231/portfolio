    ...
    return (
        <section id="contact" className="mt-72 w-[200px] sm:w-[400px] md:w-[600px] lg:w-[800px] mx-auto pb-36">
            <div className="text-2xl md:text-4xl text-left mb-12">
                <h3 className='text-blue-white'><span className="text-lg md:text-xl text-light-blue">04. </span>Contact <span className="relative top-6 left-4 text-dark-blue border-t border-grey">___________________</span></h3>
            </div>
            <div>
