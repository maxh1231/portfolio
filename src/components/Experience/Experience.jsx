    ...
    const renderJob = () => {
        if (currentJob === 0) {
            return (
                <div className='ml-4'>
                    <div>
                        <h2 className='text-2xl'>Claims Analyst @ <span>TTEC</span></h2>
                    </div>
                    <div>
        ...
        if (currentJob === 1) {
            return (
                <div className='ml-4'>
                    <div>
                        <h2 className='text-2xl' >Tutor & Grader @ <span>2U</span></h2>
                    </div>
                    <div>
        ...
        if (currentJob === 2) {
            return (
                <div className='ml-4'>
                    <div>
                        <h2 className='text-2xl'>Property Insurance Agent @ <span>Teleperformance</span></h2>
                    </div>
                    <div>
        ...
        if (currentJob === 3) {
            return (
                <div className='ml-4'>
                    <div>
                        <h2 className='text-2xl'>Account Manager @ <span>Discover Financial Services</span></h2>
                    </div>
                    <div>
