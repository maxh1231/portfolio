...
const Projects = () => {
    return (
        <section id="projects" className="flex flex-col w-[600px] md:w-[1200px] m-auto mt-72 mx-72">
            <div>
            ...
            <div>
                <div className="flex flex-row text-right mb-16 items-center">
                    ...
                    <div className="flex flex-col ">
                        ...
                        <div className="relative right-40 top-0 w-[300px] md:w-[600px] text-base text-grey bg-dark-blue-bg p-7 rounded-lg bg-dark-blue-bg">
                ...
                <div className="flex flex-row text-right mb-8 items-center">
                    ...
                    <div>
                        ...
                        <div className="relative right-40 w-[300px] md:w-[600px] text-base text-grey bg-dark-blue-bg p-7 rounded-lg">
